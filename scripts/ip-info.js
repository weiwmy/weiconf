var url = "https://ipinfo.io/json?token=79a900cd0b1b7d"
var opts = {
...
for (i=0;i<paras.length;i++) {
  cnt[paras[i]] = paras[i] == "country"? cnt[paras[i]]+" ⟦"+flags.get(cnt[paras[i]].toUpperCase())+"⟧":cnt[paras[i]]
